...
//  * @author : gifteddaves
//  * @youtube : https://www.youtube.com/@gifteddaves
...
async function writeExifImg (media, metadata) {
    ...
    if (metadata.packname || metadata.author) {
        ...
        const json = {
            "sticker-pack-id": `https://github.com/gifteddaves`,
...
async function addExif(buffer, packname, author, categories = [''], extra = {}) {
	const img = new Image();
	const json = { 'sticker-pack-id': 'gifteddaves', 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': categories, 'is-avatar-sticker': 1, ...extra };
